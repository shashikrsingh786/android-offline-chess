    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col items-center justify-center p-4 select-none'>
      ...
      <div className='mt-8 text-center'>
        <div className='flex items-center justify-center gap-2 text-gray-400 text-sm'>
          <span>Built by</span>
          <a
            href="https://github.com/shashikrsingh786/android-offline-chess"
            target="_blank"
          ...
          <div className='bg-slate-800 border border-slate-600 rounded-2xl p-6 max-w-sm w-full shadow-2xl'>
            <div className='text-center mb-6'>
              ...
              <p className='text-gray-400 text-sm'>
                Are you sure you want to leave the game? This action will end the game for all players.
              </p>
            </div>
            ...
            <div className='flex gap-3'>
              ...
              <button
                className='flex-1 bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200'
